...
<!-- 标题 -->
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-8">
				<input class="btn btn-default btn-success" type="button" data-toggle="modal" data-target="#myModal" onclick="addemp()" value="新增">
				...
				<table class="table table-striped">
					...
					<c:forEach items="${pi.list }" var="p">
						<tr>
							...
							<td>${p.dName }</td>
							<td>
								<button class="btn btn-default btn-success btn-sm" onclick="selbyid(${p.id})">
