...
<body>
<form action="/other/sheet1" method="post" enctype="multipart/form-data">
    公司：
    <select name="company" >
...
<div>
    <form action="/other/sheetout" method="post" id="findinfo" onsubmit="return sheetout()">
