...
<body>
<form action="/sheetxj/sheet1" method="post" enctype="multipart/form-data">
    公司：
    <select name="company" >
...
<div>
    <form action="/sheetxj/sheetout" method="post" id="findinfo" onsubmit="return sheetout()">
